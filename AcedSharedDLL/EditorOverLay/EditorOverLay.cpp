	...
	EditorOverLay::EditorOverLay(BaseSettings *settings, STATES id, AssetLibrary *assetLibrary)
	{
		...
		switch(id_)
		{
			case STATES::TILEIMAGEPICKER:
				imageSetId_ = AcedSharedDLL::IMAGESETS::TILEIMAGESET;
				break;
			case STATES::TILECOLORPICKER:
				imageSetId_ = AcedSharedDLL::IMAGESETS::TILECOLORSET;
				break;
			case STATES::OBJECTIMAGEPICKER:
				imageSetId_ = AcedSharedDLL::IMAGESETS::OBJECTIMAGESET;
				break;
			case STATES::ENEMYPICKER:
				imageSetId_ = AcedSharedDLL::IMAGESETS::ENEMYIMAGESET;
				break;
			case STATES::ITEMPICKER:
				imageSetId_ = AcedSharedDLL::IMAGESETS::ITEMIMAGESET;
				break;
		}

...
namespace AcedSharedDLL {
	...
	AcedSharedDLL::IMAGESETS InteractiveObject::GetImageSet() {
		return imageSet_;
	}
	...
	void InteractiveObject::SetImageSet(AcedSharedDLL::IMAGESETS set) {
		imageSet_ = set;
	}
	...
	bool InteractiveObject::CollisionInteraction(std::vector<Item*> &itemList) {
		...
		switch (objectType_)
		{
		case AcedSharedDLL::OBJECTTYPES::DOOR:

...
namespace StaticDLL{
	...
	class State
	{
		public:
			...
			STATICDLL_API virtual void SetAssetLibrary(AssetLibrary* assetLibrary) {
				assetLibrary_ = assetLibrary;
			}

			STATICDLL_API virtual AssetLibrary* GetAssetLibrary() {
			...
			STATICDLL_API virtual void InitState(ALLEGRO_DISPLAY *display, Settings *settings, Map *currentMap, AssetLibrary *assetLibrary) {
				return;
			};
